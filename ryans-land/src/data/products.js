export const categories = [
  ...
  { id: "kitchen", name: "Kitchen", blurb: "Cookware & utensils", img: "images/kitchen.jpg" },
  { id: "outdoors", name: "Outdoors", blurb: "Garden, camping & more", img: "images/outdoors.jpg" },
  { id: "pets", name: "Pet Supplies", blurb: "Treats, toys and care", img: "images/pets.jpg" },
  { id: "clothing", name: "Clothing", blurb: "Basics & seasonal wear", img: "images/clothing.jpg" },
  { id: "baby", name: "Baby", blurb: "Care & essentials for little ones", img: "images/baby.jpg" },
  { id: "books", name: "Books", blurb: "Fiction, non-fiction & kids", img: "images/books.jpg" },
  { id: "office", name: "Office", blurb: "Supplies & desk essentials", img: "images/office.jpg" },
  { id: "home-decor", name: "Home Decor", blurb: "Small accents & wall art", img: "images/home-decor.jpg" },
  { id: "sports", name: "Sports", blurb: "Outdoor & gym gear", img: "images/sports.jpg" },
  { id: "automotive", name: "Automotive", blurb: "Car care & accessories", img: "images/automotive.jpg" },
  { id: "beauty", name: "Beauty", blurb: "Cosmetics & skincare", img: "images/beauty.jpg" }
];
...
export const products = [
  ...
  ...Array.from({length:34},(_,i)=>({id:`p${i+7}`,title:["Kitchen Sponge 3-pk","Premium Pen 2-pk","Notepad 50-page","Reusable Straw","Keychain Light","Snack Cup","Hair Ties 12-pack","Shoe Laces","Mini Screwdriver","Measuring Spoon","Travel Toothbrush","Mini Notebook","Snack Bag","Fridge Magnet","Earbuds (basic)","Mini Flashlight"][i%16],price:1,category:"dollar-deals",img:`images/p${i+7}.jpg`})),
